...
// página porque proviene del MapPicker y es obligatoria (RN-10, HU-11).
// Espejo de server/src/validators/warehouses.validator.ts.
export const warehouseSchema = z.object({
  ...
  status: z.enum(['ACTIVE', 'INACTIVE'], { message: 'Selecciona el estado' }),
})
